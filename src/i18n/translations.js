const translations = {
  en: {
    ...
    game: {
      ...
      // ── Phase 16 additions (UI-SPEC §Copywriting Contract) ──
  ...
  es: {
    ...
    game: {
      ...
      // ── Phase 16 additions (UI-SPEC §Copywriting Contract) ──
      filterBarLabel: 'Filtros de habilidades',
      filterSkillsLabel: 'Filtrar por habilidad',
      filterCategoryLabel: 'Filtrar por categoría',
      yearLabel: 'Años',
      yearStartLabel: 'Año de inicio',
      yearEndLabel: 'Año de fin',
      yearFrom: 'desde',
      yearTo: 'hasta',
      filterReset: 'Limpiar',
      filterEmpty: 'Sin coincidencias — prueba menos filtros',
      filterEmptyHint: 'Limpia los filtros para ver todas las habilidades.',
      cardClose: 'Cerrar',
      cardHeading: '{skill}',
      cardJobsListLabel: 'Trabajos usando {skill}',
      cardJobsCount: '{n} trabajos',
      cardJobsCountSingular: '1 trabajo',
      cvCtaLabel: 'Descargar CV (Español)',
