...
- [x] **INFRA-05**: Self-hosted fonts via @fontsource replacing Google Fonts CDN
...
- [x] **DSGN-03**: Global `prefers-reduced-motion` CSS rules disabling all animations when OS setting is on
- [x] **DSGN-04**: CSS custom properties bridging Tailwind tokens for runtime flexibility

### Navigation

- [x] **NAV-01**: Mobile hamburger menu with full-screen overlay, body scroll lock, and keyboard accessibility
- [x] **NAV-02**: Smooth scroll to anchor sections on nav link click
- [x] **NAV-03**: Scroll spy highlighting active section in navigation
...
- [x] **SEO-03**: Lighthouse Performance score 90+ on mobile with throttling
...
- [x] **RESP-02**: All animations perform smoothly on mobile devices without jank
